...
function Navbar({ onScrollHowTo }) {
  return (
    <nav className="fixed top-0 left-0 w-full z-50 py-2 h-15 bg-[#06052c] overflow-hidden">
      <div className="flex items-center justify-start max-w-full m-0 px-8 h-12 text-gray-200">
        ...
        <ul className="flex list-none m-0 p-0">
          <li className="ml-10">
            <a href="#" className="text-gray-200 no-underline text-sm tracking-wide hover:underline" onClick={onScrollHowTo}>HOW-TO</a>
          </li>
          <li className="ml-10">
